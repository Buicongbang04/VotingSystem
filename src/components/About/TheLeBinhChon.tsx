...
const TheLeBinhChon = () => {
  return (
    <div className='flex flex-col items-center justify-center min-h-dvh gap-8'>
      <div className='pt-[4vh] sm:pt-[8vh] md:pt-[10vh] lg:pt-[10vh] xl:pt-[14vh] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12'>
        <Image
          src='/images/vote.png'
          alt='logo'
          width={877}
      ...
      >
        <ul className='space-y-4 xl:max-w-[80%] sm:text-md md:text-xl lg:text-xl xl:text-2xl font-light'>
          ...
          <li className='flex items-start'>
            <span className='text-xl sm:text-2xl md:text-3xl mr-4'>•</span>
            <span>
              Sinh viên sẽ bình chọn cho giảng viên mà bạn cảm thấy được truyền
              cảm hứng trong quá trình học tập, trao đổi tại trường.
            </span>
          </li>
          <li className='flex items-start'>
            <span className='text-xl sm:text-2xl md:text-3xl mr-4'>•</span>
            <span>
              Hệ thống sẽ tính điểm theo tổng lượt bình chọn của sinh viên dành
              cho mỗi giảng viên.
            </span>
          </li>
          <li className='flex items-start'>
            <span className='text-xl sm:text-2xl md:text-3xl mr-4'>•</span>
            <span>
              Sau thời gian bình chọn, ban tổ chức sẽ chọn ra top 10 giảng viên
              truyền cảm hứng nhất năm và vinh danh.
            </span>
          </li>
        </ul>
      </div>
